...
from registration_redux.views import ActivationView
from registration_redux.views import RegistrationView
...
urlpatterns = [
    ...
    url(r'^activate-with-template-name/(?P<activation_key>\w+)/$',
        ...
        {'template_name': 'registration_redux/test_template_name.html',
         'backend': 'registration_redux.backends.default.DefaultBackend'},
    ...
    url(r'', include('registration_redux.backends.default.urls')),
]
