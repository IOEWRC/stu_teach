...
from registration_redux.models import SupervisedRegistrationProfile
...
@override_settings(ACCOUNT_ACTIVATION_DAYS=7,
                   REGISTRATION_DEFAULT_FROM_EMAIL='registration_redux@email.com',
...
class RegistrationModelTests(TestCase):
    ...
    def test_profile_creation(self):
        """
        Creating a registration_redux profile for a user populates the
    ...
    def test_activation_email_uses_registration_default_from_email(self):
        ...
        profile = self.registration_profile.objects.create_profile(new_user)
        profile.send_activation_email(Site.objects.get_current())
        self.assertEqual(mail.outbox[0].from_email, 'registration_redux@email.com')
