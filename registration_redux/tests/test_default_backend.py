...
class DefaultBackendViewTests(TestCase):
    """
    Test the default registration_redux backend.
    ...
    def test_registration_open(self):
        ...
        whether registration_redux is permitted.
    ...
    def test_registration_get(self):
        """
        HTTP ``GET`` to the registration_redux view uses the appropriate
        template and populates a registration_redux form into the context.

        """
        resp = self.client.get(reverse('registration_register'))
        self.assertEqual(200, resp.status_code)
        self.assertTemplateUsed(resp,
                                'registration_redux/registration_form.html')
    ...
    @override_settings(
        INSTALLED_APPS=('django.contrib.auth', 'registration_redux',)
    )
    ...
    def test_activation_expired(self):
        ...
        self.assertEqual(200, resp.status_code)
        self.assertTemplateUsed(resp, 'registration_redux/activate.html')
