...
from registration_redux.models import UserProfile
...
class PasswordChangeFormOverrided(PasswordChangeForm):
    new_password1 = forms.CharField(
        label=_("New password"),
        widget=forms.PasswordInput,
        strip=False,
        help_text='The password must be of 8 character long including numerals, alphabets and symbols.',
    )
...
class RegistrationFormNoFreeEmail(RegistrationForm):
    """
    Subclass of ``RegistrationForm`` which disallows registration_redux with
