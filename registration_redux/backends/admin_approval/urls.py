...
from registration_redux.backends.admin_approval.views import ResendActivationView
...
urlpatterns = [
    ...
    url(r'^activate/complete/$',
        TemplateView.as_view(
            template_name='registration_redux/activation_complete_admin_pending.html'
        ),
    ...
    url(r'^approve/complete/$',
        TemplateView.as_view(
            template_name='registration_redux/admin_approve_complete.html'),
    ...
    url(r'^register/complete/$',
        TemplateView.as_view(
            template_name='registration_redux/registration_complete.html'),
        name='registration_complete'),
    url(r'^register/closed/$',
        TemplateView.as_view(
            template_name='registration_redux/registration_closed.html'),
...
if getattr(settings, 'INCLUDE_AUTH_URLS', True):
    urlpatterns += [
        url(r'', include('registration_redux.auth_urls')),
    ]
