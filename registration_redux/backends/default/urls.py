...
urlpatterns = [
    url(r'^activate/complete/$',
        TemplateView.as_view(template_name='registration_redux/activation_complete.html'),
    ...
    url(r'^register/complete/$',
        TemplateView.as_view(template_name='registration_redux/registration_complete.html'),
        name='registration_complete'),
    url(r'^register/closed/$',
        TemplateView.as_view(template_name='registration_redux/registration_closed.html'),
