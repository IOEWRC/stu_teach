...
class UserProfile(models.Model):
    ...
    def get_avatar_url(self):
        ...
        elif self.socio_auth_avatar:
            return self.socio_auth_avatar
...
class RegistrationProfile(models.Model):
    ...
    user account registration_redux.
    ...
    account registration_redux and activation.
    ...
    class Meta:
        verbose_name = _('registration_redux profile')
        verbose_name_plural = _('registration_redux profiles')
    ...
    def send_activation_email(self, site, request=None):
        ...
        ``registration_redux/activation_email_subject.txt``
        ...
        ``registration_redux/activation_email.txt``
            This template will be used for the text body of the email.

        ``registration_redux/activation_email.html``
...
class SupervisedRegistrationManager(RegistrationManager):
    ...
    def send_admin_approve_email(self, user, site, request=None):
        ...
        ``registration_redux/admin_approve_email_subject.txt``
            This template will be used for the subject line of the
            email. Because it is used as the subject line of an email,
            this template's output **must** be only a single line of
            text; output longer than one line will be forcibly joined
        ...
        ``registration_redux/admin_approve_email.txt``
            This template will be used for the text body of the email.

        ``registration_redux/admin_approve_email.html``
            This template will be used for the html body of the email.
        ...
        if not registration_admins:
            warnings.warn('No registration_redux admin defined in'
                          ' settings.REGISTRATION_ADMINS.'
                          ' Using settings.ADMINS for the admin approval',
                          UserWarning)
        if not admins:
            raise ImproperlyConfigured(
                'Using the admin_approval registration_redux backend'
...
class SupervisedRegistrationProfile(RegistrationProfile):
    ...
    def send_admin_approve_complete_email(self, site, request=None):
        ...
        ``registration_redux/admin_approve_complete_email_subject.txt``
            This template will be used for the subject line of the
            email. Because it is used as the subject line of an email,
            this template's output **must** be only a single line of
            text; output longer than one line will be forcibly joined
        ...
        ``registration_redux/admin_approve_complete_email.txt``
            This template will be used for the text body of the email.

        ``registration_redux/admin_approve_complete_email.html``
            This template will be used for the text body of the email.
