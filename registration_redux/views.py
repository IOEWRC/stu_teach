...
from registration_redux.forms import ResendActivationForm

from registration_redux.forms import UserForm, ProfileForm
...
def edit_profile(request):
    if request.method == "POST":
        ...
        if user_form.is_valid() and profile_form.is_valid():
            user_form.save()
            profile_form.save()
            return redirect('view_self_profile')
    else:
        user_form = UserForm(instance=request.user)
        profile_form = ProfileForm(instance=request.user.profile)
    return render(request, 'registration_redux/edit_profile.html', {
        'user_form': user_form,
...
def view_profile(request, pk=None):
    if pk:
        ...
        user = request.user
    return render(request, 'registration_redux/user_profile.html', {'user': user})


REGISTRATION_FORM_PATH = getattr(settings, 'REGISTRATION_FORM',
                                 'registration_redux.forms.RegistrationForm')
...
class RegistrationView(FormView):
    """
    Base class for user registration_redux views.
    ...
    success_url = None
    template_name = 'registration_redux/registration_form.html'
    ...
    def registration_allowed(self):
        """
        Override this to enable/disable user registration_redux, either
    ...
    def register(self, form):
        """
        Implement user-registration_redux logic here.
...
class ActivationView(TemplateView):
    ...
    template_name = 'registration_redux/activate.html'
...
class ResendActivationView(FormView):
    ...
    template_name = 'registration_redux/resend_activation_form.html'
...
class ApprovalView(TemplateView):
    ...
    http_method_names = ['get']
    template_name = 'registration_redux/admin_approve.html'
